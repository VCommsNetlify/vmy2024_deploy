...
const timer = setInterval(function() {
    ...
    document.getElementById("countdown").innerHTML = `
        <div>${padNumbers(days)}<span class="timer">DAYS</span></div>
        <div>${padNumbers(hours)}<span class="timer">HOURS</span></div>
        <div>${padNumbers(minutes)}<span class="timer">MINUTES</span></div>
        <div>${padNumbers(seconds)}<span class="timer">SECONDS</span></div>
    `;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    viewMoreBtn.addEventListener('click', function() {
        ...
        this.textContent = this.textContent === 'VIEW LESS' ? 'VIEW MORE' : 'VIEW LESS';
    });
});
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    viewMoreButton.addEventListener("click", function() {
        ...
        if (viewMoreButton.textContent === "VIEW MORE STORIES") {
            viewMoreButton.textContent = "VIEW LESS STORIES";
        } else {
            viewMoreButton.textContent = "VIEW MORE STORIES";
        }
    });
});
