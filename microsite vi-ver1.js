...
const timer = setInterval(function() {
    ...
    document.getElementById("countdown").innerHTML = `
        <div>${padNumbers(days)}<span class="timer">NGÀY</span></div>
        <div>${padNumbers(hours)}<span class="timer">GIỜ</span></div>
        <div>${padNumbers(minutes)}<span class="timer">PHÚT</span></div>
        <div>${padNumbers(seconds)}<span class="timer">GIÂY</span></div>
    `;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    viewMoreBtn.addEventListener('click', function() {
        ...
        this.textContent = this.textContent === 'XEM ÍT' ? 'XEM THÊM' : 'XEM ÍT';
    });
});
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    viewMoreButton.addEventListener("click", function() {
        ...
        if (viewMoreButton.textContent === "XEM THÊM CÁC CÂU CHUYỆN") {
            viewMoreButton.textContent = "XEM ÍT CÂU CHUYỆN";
        } else {
            viewMoreButton.textContent = "XEM THÊM CÁC CÂU CHUYỆN";
        }
    });
});
